...
class PengeluaranController extends Controller
{
    ...
    {
        // Tolak edit jika pengeluaran dihasilkan otomatis dari input bahan baku
        if ($pengeluaran->isAutoGenerated()) {
            return redirect()->route('pengeluaran.index')
                ->with('error', 'Pengeluaran ini dicatat otomatis dari data bahan baku. Silakan edit dari halaman Bahan Baku.');
        }
    ...
    {
        // Tolak update jika pengeluaran dihasilkan otomatis dari input bahan baku
        if ($pengeluaran->isAutoGenerated()) {
            return redirect()->route('pengeluaran.index')
                ->with('error', 'Pengeluaran ini dicatat otomatis dari data bahan baku. Tidak bisa diedit dari sini.');
        }
    ...
    {
        // Tolak hapus jika pengeluaran dihasilkan otomatis dari input bahan baku
        if ($pengeluaran->isAutoGenerated()) {
            return redirect()->route('pengeluaran.index')
                ->with('error', 'Pengeluaran ini dicatat otomatis dari data bahan baku. Hapus dari halaman Bahan Baku.');
        }
